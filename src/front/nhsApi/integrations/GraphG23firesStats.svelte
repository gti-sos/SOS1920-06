<script>
    async function loadGraph(){
        ...
        const resDataOtro = await fetch("https://sos1920-23.herokuapp.com/api/v2/fires-stats");
        ...
        for (var i in YourData) {
            var auxOther = [];
            auxOther.push(YourData.map(function(d) { return d["community"]})[i]);
            auxOther.push(YourData.map(function(d) { return d["total_fire"]})[i]);
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Integration with G23 api fires stats'
            },
            ...
            series: [{
                ...
                tooltip: {
                    pointFormat: 'Urban and total_fire: <b> {point.y}</b><br>' +
                        'Año: <b> {point.z} </b><br>'
                },
                colorByPoint: true
            }]
