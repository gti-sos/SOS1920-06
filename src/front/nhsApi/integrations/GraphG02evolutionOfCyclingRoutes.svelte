<script>
    async function loadGraph(){
        ...
        const resDataOtro = await fetch("https://sos1920-02.herokuapp.com/api/v2/evolution-of-cycling-routes");
        ...
        for (var i in YourData) {
            ...
            auxOther.push(YourData.map(function(d) { return d["metropolitan"]})[i]);
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Integration with G02 api evolution of cycling routes'
            },
            ...
            series: [{
                ...
                tooltip: {
                    pointFormat: 'Urban and metropolitan: <b> {point.y}</b><br>' +
                        'Año: <b> {point.z} </b><br>'
                },
                colorByPoint: true
            }]
