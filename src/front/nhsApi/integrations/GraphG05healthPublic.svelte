<script>
    async function loadGraph(){
        ...
        const resDataOtro = await fetch("https://sos1920-05.herokuapp.com/api/v1/health_public");
        ...
        for (var i in YourData) {
            ...
            auxOther.push(YourData.map(function(d) { return d["total_spending"]})[i]);
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Integration with G05 api health public'
            },
            ...
            series: [{
                ...
                tooltip: {
                    pointFormat: 'Urban and total_spending: <b> {point.y}</b><br>' +
                        'Año: <b> {point.z} </b><br>'
                },
                colorByPoint: true
            }]
