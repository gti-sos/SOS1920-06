<script>
    async function loadGraph(){
        ...
        const resDataOtro = await fetch("https://sos1920-01.herokuapp.com/api/v2/poverty-stats");
        ...
        for (var i in YourData) {
            ...
            auxOther.push(YourData.map(function(d) { return d["poverty_prp"]})[i]);
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Integration with G01 api poverty stats'
            },
            ...
            series: [{
                ...
                tooltip: {
                    pointFormat: 'Urban and poverty_prp: <b> {point.y}</b><br>' +
                        'Año: <b> {point.z} </b><br>'
                },
                colorByPoint: true
            }]
