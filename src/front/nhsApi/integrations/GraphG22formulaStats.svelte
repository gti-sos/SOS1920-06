<script>
    async function loadGraph(){
        ...
        for (var i in YourData) {
            ...
            auxOther.push(YourData.map(function(d) { return d["totalpointnumber"]})[i]);
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Integration with G22 api formula stats'
            },
            ...
            series: [{
                ...
                tooltip: {
                    pointFormat: 'Urban and totalpointnumber: <b> {point.y}</b><br>' +
                        'Año: <b> {point.z} </b><br>'
                },
                colorByPoint: true
            }]
