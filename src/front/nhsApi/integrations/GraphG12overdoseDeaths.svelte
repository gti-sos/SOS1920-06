<script>
    async function loadGraph(){
        ...
        const resDataOtro = await fetch("https://sos1920-12.herokuapp.com/api/v2/overdose-deaths");
        ...
        for (var i in YourData) {
            ...
            auxOther.push(YourData.map(function(d) { return d["death_male"]})[i]);
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Integration with G12 api overdose-deaths'
            },
            ...
            series: [{
                ...
                tooltip: {
                    pointFormat: 'Urban and death_male: <b> {point.y}</b><br>' +
                        'Año: <b> {point.z} </b><br>'
                },
                colorByPoint: true
            }]
