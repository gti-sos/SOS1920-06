...
*/
    ...
    app.post(BASE_PATH + "/lottery-sales",(req,res) =>{
        ...
        db.find({province:newSale.province,year:newSale.year},(err,sales)=>{
            ...
            }else if(sales.length>=1){ // Ya existe un dato para esa provincia y ese año
    ...
    app.put(BASE_PATH +"/lottery-sales/:province/:year",(req,res)=>{
        ...
        // province y year almacenan la provincia y el año indicados en la URL
        var province=req.params.province;
        var year=parseInt(req.params.year);
        ...
        if(province!=data.province||year!=data.year){
            ...
            // si no coinciden año o provincia de la URL y del recurso del body
            res.status(400).send("URL and body data do not match");
            console.log("URL and body data do not match")
        }else{
            //si coinciden año y provincia de la URL y del recurso del body
    ...
    app.delete(BASE_PATH+"/lottery-sales/:province/:year", (req,res)=>{
        ...
        // almacenamos en province y year la provincia y el año que indicamos en la URL
        var province = req.params.province;
        var year = parseInt(req.params.year);
    ...
    app.get(BASE_PATH+"/lottery-sales", (req,res) =>{
        ...
        // Busqueda : Iremos añadiendo parametros para buscar todos los que se encuentren en la URL
        var busqueda = {};
        ...
        // Si offset y limit existen, se devolverán 'limit' recursos a partir del 'offset' recurso
